...
class TransactionHistory {
  ...
  List<Expense> filterTransactions({String? category, DateTime? startDate, DateTime? endDate}) {
    return _transactions.where((transaction) {
      final matchesCategory = category == null || transaction.category == category;
      final matchesDateRange = (startDate == null || transaction.date.isAfter(startDate)) &&
